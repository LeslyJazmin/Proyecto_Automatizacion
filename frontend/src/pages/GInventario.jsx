...
export default function GInventario() {
  ...
  // Se determina el estado activo del botón en el Sidebar
  const sidebarActive = location.pathname;

  return (
    <div className="bg-gray-100 text-gray-900 min-h-screen">
      {/* El Sidebar es fijo y no necesita un contenedor flex en el padre */}
      <Sidebar onLogout={handleLogout} logoutOpen={modalOpen} active={sidebarActive} />

      {/* Contenido principal, que usa un margen para no superponerse con el Sidebar */}
